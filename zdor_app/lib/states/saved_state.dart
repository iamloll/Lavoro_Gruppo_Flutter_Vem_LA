...
class SavedState extends ChangeNotifier {
  ...
  UnmodifiableListView<Recipe> get savedRecipes => UnmodifiableListView(_savedRecipes);
  ...
  void removeSavedRecipe(Recipe recipe) {
    ...
    _savedRecipes.firstWhere((element) => element.id == recipe.id).isFavourite = "false";
